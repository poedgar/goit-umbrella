...
<footer class="footer bg-black text-gray-68 py-5 md:py-8 xl:py-16">
	<div class="container flex flex-col gap-[80px] md:gap-16">
		...
		<!-- Footer bottom -->
		<div
			class="flex flex-col md:flex-row justify-center md:justify-between items-center md:items-start xl:gap-[184.57px] text-center md:text-left text-base/[24px] text-gray-68">
			<!-- Agreements links -->
