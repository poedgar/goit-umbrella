...
<div class="relative flex justify-center xl:inline-block text-left xl:mr-4">
	<button id="mobile-language-toggle"
		...
		<svg class="hidden mobile-language-toggle--arrow-white" id="mobile-language-toggle--arrow-white" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="currentColor">
	...
	<div id="mobile-language-dropdown"
		class="mobile-language-dropdown absolute left-0 mt-1 w-full bg-white shadow-md text-sm hidden rounded-b">
