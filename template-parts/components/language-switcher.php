...
<div class="relative inline-block text-left xl:mr-4 rounded-t">
	<button id="mobile-language-toggle"
		...
		<svg id="mobile-language-toggle--arrow" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="none">
