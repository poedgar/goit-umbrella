...
<div class="relative flex justify-center xl:inline-block text-left xl:mr-4">
	<button id="mobile-language-toggle"
		...
		<svg id="mobile-language-toggle--arrow-black" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="currentColor">
		...
		<svg class="hidden" id="mobile-language-toggle--arrow-white" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="currentColor">
