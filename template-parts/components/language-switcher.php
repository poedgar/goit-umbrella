...
<div class="relative flex flex-col justify-center xl:inline-block text-left xl:mr-4">
	<button class="mobile-language-toggle flex justify-center items-center gap-[10px] px-4 py-2 text-[20px]/[28px] rounded-t">
		<span><?= esc_html($current_label); ?></span>

		<svg class="mobile-language-toggle--arrow-black" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="currentColor">
		...
		<svg class="hidden mobile-language-toggle--arrow-white" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="currentColor">
		<path d="M7.04761 7.31467C6.99908 7.37038 6.95813 7.43241 6.91747 7.4941C6.47288 8.16863 5.52713 8.16863 5.08253 7.4941C5.04187 7.43241 5.00092 7.37038 4.95239 7.31467L0.225467 1.88833C0.176938 1.83262 0.133193 1.77219 0.10381 1.7044C-0.235517 0.921568 0.296444 9.88424e-07 1.12704 9.10801e-07L10.873 0C11.7036 -7.76231e-08 12.2355 0.921567 11.8962 1.7044C11.8668 1.77219 11.8231 1.83262 11.7745 1.88833L7.04761 7.31467Z" fill="white"/>
		</svg>
	</button>

	<div class="mobile-language-dropdown xl:absolute left-0 w-full bg-white shadow-md text-sm hidden rounded-b">
