	...
	<header class="header bg-body sticky top-0 z-[9999] py-5 md:py-8">
		<div class="container">
			<nav class="flex items-center justify-between">
				...
				<div class="!bg-transparent !hidden xl:!flex items-center h-[44px] gap-8 xl:ml-auto xl:mr-4">
					<?php
					wp_nav_menu(array(
		...
		<div class="container py-8 h-full flex flex-col">
           ...
           max-h-0 opacity-0"> <?php if (!empty($all_sites)) : ?>
				...
				wp_nav_menu(array(
					'theme_location' => 'primary',
					'container' => false,
					'menu_class' => 'w-full space-y-8 text-center text-lg',
					'fallback_cb' => false,
