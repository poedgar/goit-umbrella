...
<p>
    <label>
        <input type="checkbox" name="show_initiatives_section" value="1" <?php checked($show, '1'); ?>
            id="show-initiatives">
        Показувати секцію «Ініціативи»
    </label>
</p>

<div id="initiatives-fields"
    ...
    <p>
        ...
        <input type="text" name="initiatives_section_title" style="width:100%"
            value="<?php echo esc_attr($title ?: 'ВІРИМО В ОСВІТУ, ЩО РУХАЄ ВПЕРЕД'); ?>">
    </p>
    <p>
        <label><strong>Підзаголовок</strong></label><br>
        <textarea name="initiatives_section_sub" rows="3"
            style="width:100%"><?php echo esc_textarea($subtitle ?: 'ТОМУ ПІДТРИМУЄМО СОЦІАЛЬНІ ТА ОСВІТНІ ІНІЦІАТИВИ Й ЗАПУСКАЄМО ВЛАСНІ'); ?></textarea>
    </p>
...
<div class="initiative-item"
    style="margin:15px 0; padding:15px; border:1px solid #ccc; background:#fff; border-radius: 1px solid #ddd;">
    <div class="photo-wrapper" style="margin-bottom:15px;">
        <strong>Фото</strong><br>
        <div class="photo-preview"
            style="width:120px;height:120px;border:2px dashed #ccc;background:#f9f9f9;overflow:hidden;">
            <?php if ($photo) : ?>
            <img src="<?php echo esc_url($photo); ?>" style="width:100%;height:100%;object-fit:cover;">
            <?php endif; ?>
        </div>
        <input type="hidden" name="initiatives_list[<?php echo $index; ?>][photo]" class="photo-url-input"
    ...
    <p><input type="text" name="initiatives_list[<?php echo $index; ?>][title]" placeholder="Заголовок ініціативи"
            style="width:100%" value="<?php echo esc_attr($title); ?>"></p>
    <p><textarea name="initiatives_list[<?php echo $index; ?>][description]" placeholder="Опис" rows="3"
            style="width:100%"><?php echo esc_textarea($desc); ?></textarea></p>
