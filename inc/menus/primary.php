    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        if ($depth === 0) {
            ...
            if ($has_children) {
                ...
                $class = $is_first ? 'btn-border-gradient-ai-base text-[20px] text-black border-2 border-black px-4 py-2 rounded' : 'text-[20px] text-black hover:text-gray-600 transition-colors';
