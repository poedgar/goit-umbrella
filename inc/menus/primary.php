    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        if ($depth === 0) {
            ...
            if ($has_children) {
                ...
                $class = $is_first ? 'btn-transparent text-black px-4 py-2 border-2 border-black rounded hover:bg-black hover:text-white' : 'text-black hover:text-gray-600 transition-colors';
