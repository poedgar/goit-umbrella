	...
	<div class="container">
		...
		<div class="grid gap-5 md:gap-8 xl:flex xl:flex-row-reverse">
			...
			<div class="flex flex-col gap-5 md:gap-8 xl:items-center xl:justify-center">
				...
				<?php if ($description): ?>
					<p class="text-[20px]/[28px] text-[#FF0000] font-medium uppercase md:text-[24px]/[32px] text-center xl:text-left text-gray xl:text-[32px]/[36px]"><?= wp_kses_post($description); ?></p>
					</p>
				<?php endif; ?>
			</div>
