  ...
  <div class="container">
    ...
    <div class="bg-black text-white p-[20px] md:py-8 md:px-8 xl:py-[128px] xl:px-[64px] rounded-[8px]">
        ...
        <div class="flex flex-col">
            ...
            class="btn-border-gradient mt-auto w-[126px] h-[44px] text-white text-[20px]/[28px] border border-white px-4 py-2 rounded-[4px] hover:bg-black text-center inline-block">
