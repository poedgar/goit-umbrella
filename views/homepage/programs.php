                ...
                <div class="bg-white rounded-lg p-6 shadow-sm flex gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <a href="<?= esc_url($cta_link); ?>"
                            class="inline-block border px-4 py-2 rounded hover:bg-black hover:text-white transition">
                            <?= esc_html($cta_label); ?>
                        </a>
                        <?php endif; ?>
            ...
            <div class="space-y-8">
                ...
                <div class="rounded-lg p-8 text-center" style="background:<?= esc_attr($bg); ?>; color:#111;">
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-6 text-left">
                        <div>
                            <?php if ($left_v): ?>
                            <div class="text-2xl font-bold"><?= esc_html($left_v); ?></div>
                            <?php endif; ?>
                            <?php if ($left_l): ?>
                            <div class="text-sm"><?= esc_html($left_l); ?></div>
                            <?php endif; ?>
                        </div>

                        <div>
                            <?php if ($right_v): ?>
                            <div class="text-2xl font-bold"><?= esc_html($right_v); ?></div>
                            <?php endif; ?>
                            <?php if ($right_l): ?>
                            <div class="text-sm"><?= esc_html($right_l); ?></div>
                            <?php endif; ?>
                        </div>
                    </div>
